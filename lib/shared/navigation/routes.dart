...
import 'package:african_windows/pages/happi/happi_dashboard.dart';
...
class Routes {
  ...
  static const String happiDashboard =
      "/happi-dashboard"; // Ajoutez cette ligne
  ...
  Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case happiDashboard: // Ajoutez cette case
        return AuthenticatedRoute(
          builder: (context) => const HappiDashboardPage(),
          adminOnly: false,
          settings: settings,
        );
      default:
